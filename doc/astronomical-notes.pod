...
an astronomical yaer is an integer number of days (365, of course), 
...
position of the Moon, the stars and the planets.
...
angle decreases by 356 nanodegrees per day (3.56 E-7 °/d,
1.3 E-4 °/yr).
...
On 4th Jan, the true solar noon at Anti-Greenwich happens at 12:04:56
...
We need 8.2271 hours (8 h 13 mn 39 s) to run this angle and the sunset for
...
Q: Why does C<Astro::Sunrise> need the year to compute sunrise and sunset?
...
from our field of view, your algorithm is wrong. If you are only interested
...
Q: By the way, how did you get the seconds in the table? C<Astro::Sunrise>
does not provide the seconds.

A: Because I have used C<DateTime::Event::Sunrise> instead of C<Astro::Sunrise>,
which produces C<DateTime> objects, complete with seconds.

Q: Could we modify C<Astro::Sunrise> to give C<"hh:mm:ss"> results instead
of C<"hh:mm">?
