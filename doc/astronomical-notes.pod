...
Q: So using a parameter C<alt> with -0.833 and a parameter C<upper_limb> with 1 is stupid?

A: I would not say "stupid", but "suspicious". Actually, the usual -0.833 value comes from
three elements:
