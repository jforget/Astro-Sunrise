...
=head2 Choix de l'algorithme C<precise>
...
de Greenwich, mais nous prenons place à XXX degrés de l'équateur.

Comme tu peux le voir, aux alentours du XXX et du XXX,
...
à chaque solstice et vaut XXX. Donc une variation de hauteur de 6' produira au
maximum une variation de l'heure de XXX.
