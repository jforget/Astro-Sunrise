...
sur les deux écoles de pensée, chacun semblant ignorer "ceux d'en face".
...
du temps sidéral en tant que temps à ce sujet.
...
Q: Donc, utiliser un paramètre C<alt> à -0,833 et un paramètre C<upper_limb> à 1 est stupide ?

A: Je ne dirais pas que c'est stupide, je dirais plutôt que c'est douteux. En fait, la valeur
