...
Qui plus est, ce sont ce que j'appellerai des S<« mensonges> pour les S<adultes »>. Au début, on considérait
...
=head2 Mise en Oeuvre de l'Algorithme Simple
...
=head2 Mise en Oeuvre de l'Algorithme Précis
