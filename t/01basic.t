...
is ($9, $sunrise , "Sunrise for $1, $2");
is ($10, $sunset , "Sunset for $1, $2");
...
my ($sunrise, $sunset) = sunrise($then->year, $then->mon, $then->mday,
                              -118, 33, $offset, 0);
ok ($sunrise eq '05:44', "Test DateTime sunrise interface");
ok ($sunset eq '20:04', "Test DateTime sunset interface");
...
Calcutta, India 22 34 N 88 24 E sunrise: 04:22 sunset: 17:54
...
Copenhagen, Denmark 55 40 N 12 34 E sunrise: 02:25 sunset: 19:58
...
Manila, Philippines 14 35 N 120 57 E sunrise: 05:28 sunset: 18:28
...
Paris, France 48 48 N 2 20 E sunrise: 03:47 sunset: 19:58
